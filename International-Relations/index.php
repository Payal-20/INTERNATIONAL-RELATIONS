...
<div class="row">
<div class="col-lg-6">
<span class="logo">Border Information</span></div>
...
<div class="modal-body">
		...
		<div class="row">
		<div class="col-md-7">
<img src="image/flag.jpg" width=1200 height=500 alt="Payal Bhor" class="img-rounded">
</div>
<div class="row">
...
<div class="form-group">
  <label class="col-md-12 control-label" for="name"></label>  
  <div class="col-md-12">
  <input id="country" name="country" placeholder="Country Name" class="form-control input-md" type="text">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/map.png" width=100 height=100 alt="Payal Bhor" class="img-rounded">
		 </div>
		 <div class="col-md-5">
    <h4 style="color:#202020; font-family:'typo' ; font-size:18px; text-decoration:none" title="Find on Facebook">Akanksha Karghe</h4>
    <h4 style="color:#202020; font-family:'typo' ; font-size:18px; text-decoration:none" title="Find on Facebook">Harshada Shende</h4>
    <h4 style="color:#202020; font-family:'typo' ; font-size:18px; text-decoration:none" title="Find on Facebook">Payal Bhor</h4>
    <h4 style="color:#202020; font-family:'typo' ; font-size:18px; text-decoration:none" title="Find on Facebook">Pooja Phad</h4>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1"></h4>
		<h4 style="font-family:'typo' "></h4>
		<h4 style="font-family:'typo' ">International Relations</h4></div></div>
		</p>
      </div>
